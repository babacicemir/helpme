...
router.post('/job/:id/message', checkJWT,validation.validateCreateMessage, User.sendMessage)
...
router.post('/message/:id/reply', checkJWT, validation.validateCreateReplyMessage, User.createReplyToMessage)
